            ...
            <table cellpadding="1" cellspacing="1" style="width:500px">
              <tbody>
                <tr>
                  ...
                  <td>{{$terima->terima_mailroom}}</td>
                </tr>
                <tr>
                  <td>
                  <p>No Resi:</p>
                  </td>
                  <td>{{$terima->no_resi}}</td>
                </tr>
                <tr>
                  <td>
                  <p>Kurir:</p>
                  </td>
                  <td>{{$terima->Kurir->nama}}</td>
                </tr>
                <tr>
                  <td>
                  <p>pengirim:</p>
                  </td>
                  <td>{{$terima->nama_guest}}, {{$terima->kota_guest}}</td>
                </tr>
                <tr>
                  <td>
                  <p>penerima:</p>
                  </td>
                  <td>{{$terima->User1->name}}</td>
                </tr>
                <tr>
                  <td>
                  <p>Tipe Barang:</p>
                  </td>
                  <td>{{$terima->tipe_barang}}</td>
                </tr>
              </table>
            </div>
        
    <form class="form-horizontal" role="form" action="{{route('terima.updateterima', $terima->id)}}" method='POST' enctype="multipart/form-data">
      @csrf
      @method('patch')
