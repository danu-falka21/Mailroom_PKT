...
@section('sub-judul','Paket Diterima')
@section('content')
    ...
    <section class="content">
      ...
      <div class="card card-primary">
        <div class="card-header">
          <h3 class="card-title">Tabel Terima Paket @if(auth()->user()->role == '2') ( {{auth()->user()->Unitkerja->nama}} ) @endif</h3>
        ...
        @endif
            ...
            <div class="table-responsive">
                ...
                <tr>
                    ...
                    <td><a type="button" class="btn btn-danger" href="{{route('terima.updateview', $hasil->id)}}">Belum Diambil</a></td>
                    @else  
                    ...
                    @endif
                    <td>
                    <form action="{{route('terima.destroy', $hasil->id)}}" method="POST">
                          @csrf 
                          @method('delete')
                        <a type="button" class="btn btn-warning" href="{{route('terima.edit', $hasil->id)}}"><i class="fas fa-edit"></i></a>
  ...
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Tambah Terima Paket</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <form class="form-horizontal" role="form" action="{{route('terima.store')}}" method='POST' enctype="multipart/form-data">
      @csrf
            <div class="card-body">
            @if(auth()->user()->role == '1')
